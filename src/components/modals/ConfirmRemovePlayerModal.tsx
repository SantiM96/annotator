...
export function ConfirmRemovePlayerModal({ isOpen, onClose, onConfirm }: Props) {
  return (
    <Modal
      visible={isOpen}
      transparent
    ...
    >
      ...
      >
        <View style={sharedModalStyles.modalCard}>
          <Text style={sharedModalStyles.modalTitle}>Remove player?</Text>
          ...
          <View style={sharedModalStyles.actionsRow}>
            ...
            >
              <Text style={sharedModalStyles.btnText}>Remove</Text>
            </Pressable>
          </View>
        </View>
      </KeyboardAvoidingView>
